...
namespace fusion {
	...
	KeyDetails::KeyDetails(const VirtualKey input_key, const std::string display_name, const unsigned int key_flags)
		: _input_key(input_key), _display_name(display_name)
	{
		initialize(key_flags);
	}

	void KeyDetails::initialize(const unsigned int key_flags)
	{
